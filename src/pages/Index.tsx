        ...
        <div className="container">
          <motion.div {...fadeUp} className="mx-auto max-w-3xl text-center">
            <motion.div
              ...
              className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/5 px-4 py-1.5 text-xs font-medium text-primary mb-6 backdrop-blur-sm">Technical and Cognitive Debt Caused by AI Induced code
